...
public class CasoDeUsoColocacionInicial {
    ...
    public ArrayList<Recurso> colocarConstruccionInicial(Coordenadas coordenadas, Construccion construccion, String jugador){
        ...
        if (!tablero.sePuedeConstruirInicial(coordenadas, construccion)){
            throw new IllegalArgumentException("No se puede construir aqui"); //cambiar excepcion
        }
        var recursos = tablero.colocarConstruccionInicial(construccion, coordenadas, jugador); //devuelve recursos siempre, el primer poblado solo los desecha
        return recursos;
    }
}
